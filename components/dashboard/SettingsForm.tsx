...
export default function SettingsForm({ initialUser }: SettingsFormProps) {
    ...
    const handleProfileSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        startProfileTransition(async () => {
            const res = await updateInstructorProfile(null, formData);
            if (res.success) {
            ...
            {showDeleteModal && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-xs p-4 animate-in fade-in duration-200">
                    <div className="bg-white rounded-xl max-w-md w-full p-6 shadow-2xl border border-zinc-200 space-y-4">
                        ...
                        <p className="text-sm text-zinc-600">
                            Are you sure you want to permanently delete your instructor account? All your courses will be reassigned and your profile will be removed. This action cannot be undone.
                        </p>
